...
public class VungleInterstitialAdapter
   ...
   */
  private volatile RelativeLayout bannerAdContainer;
  ...
  public void requestBannerAd(Context context, MediationBannerListener mediationBannerListener,
    ...
    // Create the banner ad container with the requested ad size, as Vungle's ad uses MATCH_PARENT
    // for its dimensions.
    bannerAdContainer =
        new RelativeLayout(context) {
          ...
          protected void onAttachedToWindow() {
            ...
            vungleBannerAdapter.attach(this);
          }
    ...
    bannerAdContainer.setLayoutParams(adViewLayoutParams);
